...
const BigSlider = () => {
  ...
  return (
    <div className='pb-10 md:py-10 mx-2'>
       {/*Title */}
      <h1 className=' mb-12 sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-bold text-white'>Remove Background With High <br/> Quality and Accuracy</h1>
